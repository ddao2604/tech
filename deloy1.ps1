...
Invoke-WebRequest 'https://raw.githubusercontent.com/ddao2604/tech/main/temp.json' -OutFile temp1.json
...
While($run)
{
	...
	(Get-Content temp1.json).Replace($ft, $st) | Set-Content temp1.json
